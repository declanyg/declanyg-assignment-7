...
def hypothesis_test():
    ...
    fun_message = "small small fun" if p_value <= 0.0001 else ""

    # TODO 12: Plot histogram of simulated statistics
    plot3_path = "static/plot3.png"
    # Replace with code to generate and save the plot
    plt.hist(simulated_stats, bins=30, alpha=0.7, color='blue', edgecolor='black')
    ...
    plt.xlabel(f"Simulated {parameter.capitalize()}")
    plt.ylabel("Frequency")
...
def confidence_interval():
    ...
    plt.axhline(y=true_param, color='blue', linestyle='--', label='True Parameter')
    plt.scatter([len(estimates) // 2], [mean_estimate], 
                color='green' if includes_true else 'red', 
                label='Mean Estimate', zorder=5)
    plt.errorbar(len(estimates) // 2, mean_estimate, 
                 yerr=[[mean_estimate - ci_lower], [ci_upper - mean_estimate]], 
